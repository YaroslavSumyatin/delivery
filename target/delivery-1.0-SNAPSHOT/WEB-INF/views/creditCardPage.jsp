...
<head>
    ...
    <style>
        ...
        .credit_card-container label {
            padding-bottom: 5px;
            font-size: 13px;
        }

        .credit_card-container input {
            margin-top: 3px;
            padding: 15px;
            font-size: 16px;
            width: 100%;
    ...
    <main class="container_main">
        <div class="credit_card-container">
            ...
            <div class="form-container">
                ...
                <div class="field-container">
                    <label for="cardnumber"><fmt:message key="payment.card_number"/></label><span
                        id="generatecard"><fmt:message key="payment.generate_random"/></span>
